ERROR_NOTES: RHRouter::RoutingTableEntry *route = manager->getRouteTo(n); menghasilkan route berupa null. cari tau bagaimana cara instansiasi RoutingTableEntry dengan benar
debugging:
